...
var Map = (0, import_react3.forwardRef)((props, ref) => {
  ...
  (0, import_react3.useEffect)(() => {
    ...
    let isMounted = true;
    let mapbox;
    Promise.resolve(mapLib || import("./mapbox-gl-PZNH42JI.js")).then((mapboxgl) => {
      if (!isMounted) {
        return;
      }
      if (!mapboxgl.Map) {
  ...
  const style = (0, import_react3.useMemo)(() => __spreadValues({
    position: "relative",
    width: "100%",
    height: "100%"
...
function useControl(onCreate, onRemove, opts) {
  ...
  (0, import_react6.useEffect)(() => {
    ...
    if (!map.hasControl(ctrl)) {
      map.addControl(ctrl, (_a = opts || onRemove) == null ? void 0 : _a.position);
    }
    return () => {
